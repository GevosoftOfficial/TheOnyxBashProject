...
1. Download the folder 'TheOnyxBashProject'. The easiest and recomended way to download the project (for none contributors) is to just click <a href="https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/TellSpaceOfficial/TheOnyxBashProject/tree/master/TheOnyxBashProject"> This Link </a> Or click the download buttons at the top of the page and locate the 'TheOnyxBashProject' Folder.
2. Extract zip file
